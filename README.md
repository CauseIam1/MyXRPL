...
Then load your r-address into (myxrpl.x or myxrpl.crypto).
...
If you have enough pairs of assets, the Sequential Swap Chains will start to show chains.
You can set the threshold to filter out smaller swap profit values.
The chain will display your estimated return if you follow the swaps.
The Chart section shows Tokens per XRP (Inverse of Price)
It also shows live data (minus very small transactions) of High/Low and Volume
...
Take a look at it in action (MyXRPL_DeFi.mp4)

Special thanks to the XRPL.org, Xaman and most importantly, The Pirate.

myxrpl.x or myxrpl.crypto

Direct link...

https://dweb.link/ipfs/bafybeihvuc2li4ll2ru7m7k3grpkgp5ksyuhez7d6en7eykfdeknyx2xyi
