        ...
        >
          ...
          {isPairChart ? (
            ...
            <>
              ...
              {/* Show raw swap direction data */}
              <div
                style={{ fontSize: "0.7rem", color: "#999", marginTop: "2px" }}
              ></div>

              {/* Swap Direction Arrow - Just arrows with theme-based colors */}
              {data.swapDirection && (
                <div
                  style={{
                    display: "flex",
                ...
                >
                  {data.swapDirection === "buy" ? (
                    // Buying tokens (selling XRP) - down arrow (tokens going down to XRP)
                    <span style={{ color: themes[theme].secondary }}>↓</span>
                  ) : (
                    // Selling tokens (buying XRP) - up arrow (XRP going up to get tokens)
