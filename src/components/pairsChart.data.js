import { determineBaseCurrency, asciiToHex } from "./pairsChart.utils";
...
export const fetchChartData = async (
  ...
  try {
    ...
    const ammTransactions = await fetchTransactions(
      poolAddress,
      true,
      setProgress
    );
...
export const fetchTransactions = async (account, isAmmPool, setProgress) => {
  const endpoints = [
    "wss://xrplcluster.com",
    "wss://s1.ripple.com:443",
    "wss://s2.ripple.com:51233",
